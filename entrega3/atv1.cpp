...
void dobrarValoresPonteiro(const std::vector<int>* numerosOriginais, std::vector<int>* numerosDobrados){
    ...
    //*numerosOriginais é usado para acessar o vetor para o qual o ponteiro está indicando
    for (int numero : *numerosOriginais){
        numerosDobrados->push_back(numero*2); //O operador -> é utilizado para acessar métodos e membros de uma estrutura ou classe através de um ponteiro.
    }
